...
pub const GET_BALANCE_API: &'static str = "https://walletapi-in.lianxiangcloud.com/getBalance";
pub const GET_TRANSACTION_COUNT_API: &'static str = "https://walletapi-in.lianxiangcloud.com/getTransactionCount";
...
pub const SEND_RAW_TRANSACTION_API: &'static str = "https://walletapi-in.lianxiangcloud.com/sendRawTransaction";
